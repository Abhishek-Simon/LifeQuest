...
export const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-space-md bg-background relative overflow-hidden">
      {/* Ambient Background */}
      <div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-secondary/10 rounded-full blur-[120px]"></div>
      ...
      >
        ...
        <Card glow className="p-space-xl bg-surface-deck border-border-subtle shadow-2xl">
          <div className="text-center mb-space-xl">
            ...
            <p className="font-body-md text-body-md text-text-secondary">
              Create your character and start building your real-life adventure.
            </p>
          </div>
        ...
        <p className="mt-space-lg text-center font-body-sm text-body-sm text-text-secondary">
          ...
          <Link to="/login" className="text-primary hover:text-primary-fixed transition-colors font-medium">
            Enter LifeQuest
          </Link>
        </p>
      </motion.div>
